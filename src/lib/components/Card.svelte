...
<div class={`transition-transform duration-500 ease-in-out `}>
	<div
		style=""
		class="rounded-sm lg:rounded-[4px] w-60 h-[320px] bg-[#fffef8] flex flex-col items-center pt-2 mx-10 my-10"
	>
		<img class="rounded-sm lg:rounded-[4px] w-56 h-56 object-cover" src={picture} alt="" />

		<div class="p-3 w-full text-center">
			<img class="scale-50 -mt-4 -mb-2 min-w-[70px]" src="imgs/spotify.png" alt="" />
