...
<div
	in:fly|global={{ duration: 500, y: getRandomInt(-100, 100), x: getRandomInt(-100, 100) }}
	class={`transition-transform duration-500 ease-in-out ${getRotationClass(index)} hover:rotate-0`}
>
	<div
		style="box-shadow:  0px 0px 35px 7px rgba(250, 234, 172, .2);"
		class="w-60 h-[310px] bg-[#fffef8] flex flex-col items-center pt-2 mx-10 my-10 sepia-[0.4]"
	>
		<img
			class="w-56 h-56 object-cover grayscale shadow-sm shadow-zinc-800/50"
			src={picture}
			alt=""
		/>
