...
<main class="bg-[#27232F] my-4 flex flex-col items-center">
	<div class="flex flex-col justify-center items-center lg:flex-row mb-5 lg:mb-7">
		<h1
			class="text-3xl text-center font-mono font-bold text-amber-100 mt-7 mb-2 md:text-5xl lg:flex"
		>
		...
		<label for="toggleTwo" class="flex items-center star select-none lg:mt-5 lg:ml-4 lg:mr-1">
			<div class="relative mx-2">
				...
				<div
					class="block h-12 rounded-full bg-[#4b4359] w-24 transition duration-300 ease-in-out peer-checked:bg-amber-100"
				></div>

				<div
					class="font-mono text-xl font-bold absolute w-10 h-10 transition ease-in-out duration-500 bg-amber-100 rounded-full dot left-[5px] top-1
