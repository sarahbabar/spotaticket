...
<main class="bg-[#27232F] w-screen h-screen flex">
    ...
    <div class="w-full flex flex-col items-center justify-center">
        ...
        <h1 class="font-mono font-bold text-5xl md:text-6xl tracking-wider text-amber-100 text-center mx-2 mt-6 mb-1 uppercase">TopArtist</h1>

        <h2 class="font-mono text-base md:text-lg text-amber-100 uppercase mt-2 mb-8 mx-2">Your most listened to artists</h2>
